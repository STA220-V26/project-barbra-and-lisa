Here is our readme file! To be updated!
...
Do we want to use how many "encounters" a person had to measure their health/medical expenses? 
We can create a new dataframe from enounters where we have each id number and how many encounters they had, then we add that count dataframe to the patient dataframe, and then do analysis.
Proposal: instead of creating a raw age column could we instead create an age group that can show clearer differences in plots and tables.
